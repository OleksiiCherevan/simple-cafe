...
import "./index.scss";
import ChunkCard from "../../../00-atoms/04-cards/ChunkCard";
...
const CHUNKS = [
    {
        ...
        text: "Доставка с 10:00 до 19:000",
    ...
    },
    {
        ...
        text: "Доставка с 10:00 до 19:001",
        description: "Время работы",
    },
    {
        svg: (
        ...
        text: "Доставка c 10:00 до 19:002",
        description: "Время работы",
    },
];

const BarChunks = (props) => {
